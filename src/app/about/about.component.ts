  ...
  public faq: Questions[] = [
    {
      ...
      anwsers: [
        `Kalayna (pronounced Kuh-LAY-nuh) has no particular origin, to my
    ...
    },
    {
      ...
      anwsers: [
        `This is the question I get the most, and unfortunately, it is the hardest
    ...
    },
    {
      ...
      anwsers: [
        `Thank you! I'm so glad you are interested enough in my books to want spend time reading and reviewing them.
   ...
   <a href="http://us.penguingroup.com/static/pages/aboutus/mediainquiries.html">HERE</a>. `,
    ...
    },
    {
      ...
      anwsers: [
        `Currently I have a plan for a total of six books following Kita's story.`
      ]
    },
    {
      question: `When will book three in the Novels of Haven, Third Blood, be released?`,
      anwsers: [
        `THRID BLOOD's release was pushed back. I will update you as soon as I have more information about when this book
   should be released.`
      ]
    },
    {
      ...
      anwsers: [
        `Currently Penguin has me contracted for six books. At this time, it looks like the sixth book will be the final
   and it has been planned as such. That said, I'm not opposed to exploring the world and characters beyond that point and
    ...
    },
    {
      ...
      anwsers: [
        `Nope! The very talented ladies over at Bell Bridge Books designed the covers for my Haven Series, and I have
   been absolutely thrilled with their work. The gorgeous art for GRAVE WITCH and GRAVE DANCE was created by the amazing
    ...
    },
    {
      ...
      anwsers: [
        `The Haven Series is an adult urban fantasy. That said, I was only 23 when I wrote the first book,
    ...
    },
    {
      ...
      anwsers: [
        `I do. You can check out my very first 'burn' <a href="http://www.youtube.com/watch?v=oOtJDPZ0iNw">Here</a>.`
      ]
    }
  ];
